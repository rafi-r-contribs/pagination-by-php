...
<div class="input-group offset-md-7 col-md-3 mt-5">
...
<nav>
    <ul class="pagination mt-5 justify-content-center">
        ...
        <?php if ($page > 1) {
            ?>
            <li class="page-item">
                <a class="page-link" href="pagination.php?page=<?= $previous; ?>">&laquo; Previous</a>
            </li>
        <?php } else {
            ?>
        ...
        <?php if ($page < $total_pages) {
            ?>
            <li class="page-item">
                <a class="page-link" href="pagination.php?page=<?= $next; ?>">Next &raquo;</a>
            </li>
        <?php } else {
            ?>
            <li class="page-item disabled">
